...
resource "aws_subnet_group" "this" {
  ...
  description = "Subnet group for Redis ${var.project_name} ${var.environment}"
...
resource "aws_security_group" "redis" {
  ...
  description = "Security group for Redis Single-AZ"
  vpc_id      = var.vpc_id
...
resource "aws_elasticache_replication_group" "this" {
  ...
  replication_group_description = "Redis Single-AZ for ${var.project_name} ${var.environment}"
