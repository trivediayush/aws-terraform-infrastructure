...
provider "aws" {
  ...
  default_tags {
    tags = {
      ...
      ManagedBy   = "Terraform"
      Architecture = "staging-option-2-prod-single-az"
    }
  }
}
...
# RDS Single-AZ Module
module "rds" {
  source = "../../modules/rds-single-az"
...
# Redis Single-AZ Module
module "redis" {
  source = "../../modules/redis-single-az"
